(function($) {
  ...
  $(function() {
    ...
    // Data for monthly expenditures
    const monthlyExpenditureData = [380, 320, 280, 280, 300, 350, 400, 350, 300, 450, 270, 350];

    // Create a bar chart using Chart.js
    const ctx = $('#expenditure-chart');
      ...
      options: {
        ...
        scales: {
          y: {
            beginAtZero: true,
            ticks: {
              stepSize: 100, // Adjust y-axis step size
            },
            grid: {
